    ...
    def get_data(self):
        try:
            ...
            for case in search_ids:
                ...
                flg_inv = False
                ret_data = {}
                state_list = {'new':'New','in_progress':'In Progress','cancel':'Cancelled','transfer':'Transferred', 'won':'Won', 'arbitrated':'Arbitrated', 'withdrawn':'With Drawn', 'lost':'Lost', 'inactive':'Inactive', 'done':'Closed', 'hold':'Hold'}
