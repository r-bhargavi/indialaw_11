    ...
    def update_add_remove_dept(self):
        ...
        for data_obj in self:
            ...
            if data_obj.type == 'add':
                ...
                department_pool.active_ids.write({'employee_ids':employee_ids})
            else:
