...
class DailyCSMReport(models.TransientModel):

    _name = "daily.csm.report"
    _description = "Daily CSM Report"
    ...
    def print_excel_report(self):
        ...
        Header_Text ='CSM Daily Report'
        sheet = workbook.add_sheet('CSM Daily Report')
#        sheet.row(0).height = 256 * 4
        ...
        sheet.write_merge(0, 0,0,5,'CSM DAILY REPORT',style1)
        sheet.write_merge(1,2, 0,0,'CSM NAME',style1)
        sheet.write_merge(1,2, 1,1,'OFFICE',style1)
        sheet.write_merge(1,1, 2,3,'TODAY(DATE)',style1)
        sheet.write(2,2,"TODAY'S PROF. BILLING",style1)
        sheet.write(2,3,"TODAY'S PROF. COLL.",style1)
        sheet.write_merge(1,1, 4,5,'AS ON DATE BILLING',style1)
        sheet.write(2,4,"AS ON DATE BILLING",style1)
        sheet.write(2,5,"AS ON DATE COLL.",style1)
        sheet.write(3,0,"",style1)
        sheet.write(3,1,"",style1)
        sheet.write(3,2,"",style2)
        sheet.write(3,3,"",style2)
        sheet.write(3,4,"",style1)
        sheet.write(3,5,"",style1)
        sheet.write(4,0,"",style1)
        sheet.write(4,1,"",style1)
        sheet.write(4,2,"",style2)
        sheet.write(4,3,"",style2)
        sheet.write(4,4,"",style1)
        sheet.write(4,5,"",style1)
        sheet.write_merge(5,5,0,1,"TOTAL",style1)
        sheet.write(5,2,"",style2)
        sheet.write(5,3,"",style2)
        sheet.write(5,4,"",style1)
        sheet.write(5,5,"",style1)
        row=3
        ...
        return {
             ...
             'url': '/opt/download?model=output&field=xls_output&id=%s&filename=CSM Daily Report.xls'%(attach_id.id),
             'target': 'new',
            } 
